    ...
    <div>
      ...
      <div className="input-group">
        ...
        <div className="button-group">
          <button type="button" className="btn btn-primary" onClick={() => initializeCaptcha(canvasRef.current.getContext('2d'))}>
            Обновить
          </button>
          <button type="button" className="btn btn-success" onClick={handleCaptchaSubmit}>
            Отправить
          </button>
        </div>
      </div>
